<template>
  <!-- 生活周边 -->
  <div class="living-box" @scroll="divScroll" id="back">
    <!-- 红包图片 -->
    ...
    <div class="living-wrap">
      <div class="living-item" v-for="item in content[0]" :key="item.item">
    ...
    <div class="living-list">
      <div class="living-list-item" v-for="item in content[1]" :key="item.item">
...
export default {
  ...
  created() {
    let url = "http://127.0.0.1:5500/src/data/LivingPage.json";
    let that = this;
    axios
      .get(url)
